...
const seedFollow: StudentFollowRecord[] = [
  {
    id: 1,
    studentId: 1,
    followTime: '2026-05-10 10:00',
    followType: '电话跟进',
    content: '家长咨询春季班课程安排',
    operator: '林老师',
    nextFollowTime: '2026-05-15',
  },
  {
    id: 2,
    studentId: 1,
    followTime: '2026-05-08 14:30',
    followType: '到店咨询',
    content: '体验课效果良好，有意向报名',
    operator: '林老师',
    nextFollowTime: '2026-05-10',
  },
  {
    id: 3,
    studentId: 1,
    followTime: '2026-05-03 09:00',
    followType: '微信沟通',
    content: '发送课程介绍资料',
    operator: '林老师',
    nextFollowTime: '2026-05-08',
  },
];
...
const seedTrial: StudentTrialRecord[] = [
  {
    id: 1,
    studentId: 1,
    trialDate: '2026-05-07 09:00',
    courseName: '少儿英语体验课',
    teacher: '陈老师',
    classroom: 'A101',
    feedback: '学生参与积极，口语表达流畅',
    status: '已完成',
  },
  {
    id: 2,
    studentId: 1,
    trialDate: '2026-04-25 15:00',
    courseName: '数学思维体验课',
    teacher: '周老师',
    classroom: 'B202',
    feedback: '逻辑能力较好，建议提高班',
    status: '已完成',
  },
];
...
const seedDeductions: StudentDeductionRecord[] = [
  {
    id: 1,
    studentId: 1,
    deductionTime: '2026-05-13 10:30',
    courseName: '少儿英语',
    deductHours: 2,
    type: '上课扣课',
    operator: '系统',
  },
  {
    id: 2,
    studentId: 1,
    deductionTime: '2026-05-09 10:30',
    courseName: '少儿英语',
    deductHours: 2,
    type: '上课扣课',
    operator: '系统',
  },
  {
    id: 3,
    studentId: 1,
    deductionTime: '2026-05-06 10:30',
    courseName: '少儿英语',
    deductHours: 2,
    type: '上课扣课',
    operator: '系统',
...
const seedCommunications: StudentCommunicationRecord[] = [
  {
    id: 1,
    studentId: 1,
    communicateTime: '2026-05-13 11:00',
    type: '课后反馈',
    content: '今天课堂表现良好，积极发言。建议课后复习 Unit 3 单词。',
    operator: '陈老师',
  },
  {
    id: 2,
    studentId: 1,
    communicateTime: '2026-05-11 16:00',
    type: '请假确认',
    content: '家长来电确认 5/11 请假，已安排补课。',
    operator: '林老师',
  },
  {
    id: 3,
    studentId: 1,
    communicateTime: '2026-05-06 12:00',
    type: '入学沟通',
    content: '确认课程安排和教材清单。',
    operator: '林老师',
  },
...
const seedGrowth: StudentGrowthRecord[] = [
  ...
  },
  {
    ...
    type: '阶段测试',
    content: '期中测试成绩：听力 92，口语 88，笔试 85。',
    attachments: '',
  },
  {
    id: 3,
